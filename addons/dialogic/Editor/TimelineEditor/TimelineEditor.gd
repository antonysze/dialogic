...
func add_event_by_id(event_id, event_data):
	match event_id:
		...
		_:
			return add_rr_event_by_id(event_id, event_data)

func add_rr_event_by_id(event_id, event_data):
	match event_id:
		# CUSTOM EVENTS
		# ShakeScreen event
		'dialogic_rr_001':
			return create_event('ShakeScreen', event_data)
		# ShakeCharacter event
		'dialogic_rr_002':
			return create_event('ShakeCharacter', event_data)
