...
static func start(timeline: String, reset_saves: bool=true, dialog_scene_path: String="res://addons/dialogic/CustomDialogNode.tscn", debug_mode: bool=false, use_canvas_instead=true):
